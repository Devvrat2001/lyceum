...
| Branch | `master` — pushing the cont.33 five (`334156d` syllabus-paste, `9759697` R18 tokens pilot, `6a43851` R20 Hindi pilot, `de539ba` ICU smoke, + this docs commit). Origin/prod = `d805861` (run 4 all-green). P3 board opened: R18/R20 pilots done, R24 syllabus leg done; next P3 pulls = R19 persona split, R21 board tags, R24 auto-grading, R22 offline, R26 parent self-service. R1 TLS still user-owned. |
