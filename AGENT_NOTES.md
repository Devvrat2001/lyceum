...
| Branch | `master` — **ahead 4** of `origin/master` (origin @ `cda4c82`; unpushed: `ca81cf4` docs epilogue, `0f29fa0` refund correctness, `8fcf27f` tutor cap, `9e4e12f` REQUIREMENTS). **Prod = `cda4c82`**, healthy. Next push runs verify+e2e and auto-deploys all four. |
