...
| Branch | `master` — pushing the cont.34 four (`1079fe8` boards, `564316a` free-response grading, `0319a38` persona pilot, + this docs commit). Origin/prod = `a8f3b7f` (run 5 all-green). Two migrations ride this push: course_board (with seed backfill) + free_response_grading (enum + Attempt columns). P3 remaining: R20/R19 next surfaces, R22 offline, R23 WhatsApp, R25 cohorts, R26 parent self-service, R27 earnings polish, R28 Stripe polish. R1 TLS still user-owned. |
