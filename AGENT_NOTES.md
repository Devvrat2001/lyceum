...
| Branch | `master` — 1 ahead (`7d3f02f` final CI deploy shape + this docs commit pending push) of `origin/master` @ `f9980dd`. Prod = `f9980dd` via manual CLI deploy; next green push deploys via CI. |
