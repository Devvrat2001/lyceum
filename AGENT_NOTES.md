...
| Branch | `master` — pushing the cont.41 four (`32b4f52` R36 bell, `803def3` R37 locale switcher, `a2ff0f7` R38 a11y v1, + this docs commit). Origin/prod = `8678921` (run 12 all-green). No migrations this push. **P5 nearly done:** R36/R37/R38 landed; remaining R39 (free-response XP reconcile) + R40 (sitemap/robots/.ics integration tests) + R31 (WhatsApp keys). R1 TLS user-owned — the only OPEN original-board item. |
