...
| Branch | `master` — pushing the cont.36 four (`ad2a1bc` R25 live/cohort, `1fa744d` R23 WhatsApp scaffold, `bad1507` R19/R20 lesson reader, + this docs commit). Origin/prod = `b7f3bed` (run 7 all-green). One migration rides this push: course_live_schedule. **P3 board essentially cleared** — R25 DONE-v1, R23 scaffolded; only continuations remain (R19/R20 next surfaces: library/skill-tree/chrome-nav/browse; R23 wiring the senders when keys land). R1 TLS still user-owned. |
