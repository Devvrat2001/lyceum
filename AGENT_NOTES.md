...
| Branch | `master` — pushing the cont.40 four (`44d22b6` R34 live-v2, `a26c0a1` R30-continue, + this docs commit; the R34 migration rides too). Origin/prod = `308fe45` (run 11 all-green). One migration: course_session_recurrence. **P4 essentially done** (R31 WhatsApp blocked on keys); **new P5 backlog R36-R40** is live — R36 (notification bell in all chromes) is the highest pick, and it un-buries R35's child-notify. R1 TLS user-owned. |
