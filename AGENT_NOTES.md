...
**6.4 Teacher + student discussions** — `/teacher/discussions` and `/student/community` are still `ComingSoon` stubs; no thread UI anywhere (the `DISCUSSION` block type + `BlockComment` model exist as scaffolding). (Storefront pages — ✅ done 2026-05-22, `6050321`.)
