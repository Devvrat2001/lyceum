...
| Branch | `master` — pushing the cont.44 five (`f1f57f3` R42 tests, `1455fb6` R43 account delete/export, `66ed4a1` R41 locale-aware tRPC strings, `9a8f0df` R45 reflow, + docs). Origin/prod = `685bc46` (run 15 green). **MIGRATION this push: `20260615000157_account_deletion` (User.deletedAt) — applies on Vercel deploy via `prisma migrate deploy`.** P6: R41/R42/R43/R45 done; R44 (email) user-owned. R1 TLS user-owned — the only OPEN original-board item. |
