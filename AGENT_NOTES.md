...
| Branch | `master` — pushing the cont.32 five (`c0d57ee` plan, `842983b` consent, `8c8396b` glyphs, `28db30f` + this docs commit). Origin/prod = `38876b8` (all-green). The signup_consent_fields migration rides this push. **Every REQUIREMENTS P0–P2 item except R1 (user-owned TLS) is now DONE.** |
