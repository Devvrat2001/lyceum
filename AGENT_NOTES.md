...
| Branch | `master` — pushing the cont.46 four (`e0a073e` R46 login throttle, `1f3d74e` R47 parental consent, `5267376` R48 admin perf, + docs). Prior run 17 GREEN — cont.44 migration applied. **MIGRATION this push: `20260615112714_parental_consent` (User.parentConsentAt) — must apply on deploy (watch run 18 deploy runs, not skips).** P7: R46/R47/R48 done; R49 checkout e2e + R44 email remain. R1 TLS user-owned. |
