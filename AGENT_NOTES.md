...
| Branch | `master` — pushing the cont.39 five (`38e3058` R33 review, `ff6adbe` R30-tail chrome i18n, `17efe4a` R35 parent perf, + this docs commit; one earlier was the R33 migration). Origin/prod = `7ec8cb7` (run 10 all-green). One migration rides this push: attempt_score_override. **P4 nearly done:** R29/R30(partial)/R32/R33/R35 landed; only R31 (WhatsApp wiring — needs Business API keys) + R34 (live/cohort v2) remain. R1 TLS user-owned. |
