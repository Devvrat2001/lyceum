...
- `REQUIREMENTS.md` — prioritized backlog: P0–P3 R1–R28 (2026-06-12 review, all DONE; R1 TLS-bypass verified removed from prod 2026-06-16) + **P4 R29–R35** (2026-06-14, done except R31 WhatsApp-keys-blocked) + **P5 R36–R40** (2026-06-15, all DONE) + **P6 R41–R45** (R41/R42/R43/R45 DONE; R44 email remains — user-owned) + **P7 R46–R49** (all DONE) + **P8 R50–R53** (R50 headers / R51 signup throttle / R53 cron-gate+insight-router tests DONE; **R52 i18n breadth IN PROGRESS** — TeacherEarnings/TeacherStudents/AdminPeople/AdminClasses + TeacherGrading + TeacherDiscussions [client components] + student library/skill-tree + AdminTeachers[client]/curriculum/billing + teacher paths/storefront[clients] + admin audit done — **every page R52 *enumerated* is localized, but the P9 review (2026-06-17) found the scope missed whole surfaces (auth flow, course builder, lesson reader blocks, settings, …) so i18n is NOT actually 100% → tracked as R55**; client-component i18n pattern proven via next-intl useTranslations + t.rich). **P9 (2026-06-17): R55 finish-i18n-for-real / R56 localize page titles / R57 CSP (R50 tail); feature board exhausted, product feature-complete.** **User-owned carry-overs: R44 (email — go-live checklist ready), R54 (pin `sslmode=verify-full` on prod `DATABASE_URL`).** Agent-doable work left is mainly R52's remaining page bodies (mechanical); the R50 CSP tail is low-value (inline styles ⇒ near-pointless without a nonce refactor). When R52 lands, do a fresh P9 review. Update Status inline. Its "Verified clean" section lists what NOT to re-audit.
